...
export type RecipientDataStruct = { recipient: string; split: BigNumberish };

export type RecipientDataStructOutput = [string, number] & {
  recipient: string;
  split: number;
};

export type MultirecipientFeeCollectProfilePublicationDataStruct = {
  amount: BigNumberish;
  collectLimit: BigNumberish;
  currency: string;
  currentCollects: BigNumberish;
  ...
  followerOnly: boolean;
  endTimestamp: BigNumberish;
  recipients: RecipientDataStruct[];
};

export type MultirecipientFeeCollectProfilePublicationDataStructOutput = [
  BigNumber,
  BigNumber,
  string,
  BigNumber,
  ...
  followerOnly: boolean;
  endTimestamp: BigNumber;
  recipients: RecipientDataStructOutput[];
};

export interface MultirecipientFeeCollectModuleInterface
...
export interface MultirecipientFeeCollectModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultirecipientFeeCollectModuleInterface;
  ...
  functions: {
    ...
    getPublicationData(
      ...
      pubId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[MultirecipientFeeCollectProfilePublicationDataStructOutput]>;
